...
const SellCoinTableServerSide = () => {
  ...
  function getData(params, isNoLoading) {
    ...
    if (token) {
      ...
      Service.send({
        method: 'POST', path: 'PaymentServicePackage/getListUserBuyPackage', data: newParams, query: null, headers: {
...
export default memo(SellCoinTableServerSide)
